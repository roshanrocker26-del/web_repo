...
BOOKS_DATA = {
    'ibot-series': {
        ...
        'books': {
            'class-1': {'title': 'Standard 1', 'image': 'images/ibot1.jpg', 'desc': 'Introduces young learners to smart machines, basic computer parts, and early coding concepts using ScratchJr.', 'details': [' Dealt with Do’s and don’t of a desktop computer aligned with its features, parts, and its prominent implementation in different fields.']},
            'class-2': {'title': 'Standard 2', 'image': 'images/ibot2.jpg', 'desc': 'Building on basics, exploring input/output devices, and intermediate creative projects.', 'details': ['Application towards peripheral devices, infused with different code blocks entwined with focussed real-time illustrative scenarios.']},
            'class-3': {'title': 'Standard 3', 'image': 'images/ibot3.jpg', 'desc': 'Understanding OS environments, word processing, and an introduction to computational thinking.', 'details': ['Learning computer fundamentals like generic hardware and software application tools, types of computer devices etc.']},
            'class-4': {'title': 'Standard 4', 'image': 'images/ibot4.jpg', 'desc': 'Advanced word processing, safe internet browsing, and block-based programming exercises.', 'details': ['A generic overview of the desktop computer, classifications of network devices, its types and their preferred application of use.']},
            'class-5': {'title': 'Standard 5', 'image': 'images/ibot5.jpg', 'desc': 'Presentations, spreadsheets basics, and developing algorithms using visual coding tools.', 'details': [' Make yourself familiar in knowing the concepts of algorithms, passcodes, and flowcharts in a way of distinguishing the core ideology between human and machine intelligence.']},
            'class-6': {'title': 'Standard 6', 'image': 'images/ibot6.jpg', 'desc': 'Deep dive into robotics principles, electronics basics, and intro to Python syntax.', 'details': [' Basic introduction to AI concepts along with Robotics and networking knowledge for beginners or first-time learners.']},
            'class-7': {'title': 'Standard 7', 'image': 'images/ibot7.jpg', 'desc': 'AI concepts, intermediate Python programming, and hardware integration projects.', 'details': [' Getting started with advanced AI and Robotic programming with a broader view towards Python, HTML, 5, CSS and networking niches.']},
            'class-8': {'title': 'Standard 8', 'image': 'images/ibot8.jpg', 'desc': 'Advanced robotics, IoT fundamentals, and machine learning basics.', 'details': [' Descriptive overview on Python control structures in line with embedded programming and simulation in advanced C++ and emerging cybersecurity technologies.']},
            'class-9': {'title': 'Standard 9', 'image': 'images/ibot9.jpg', 'desc': 'Comprehensive IT matrix, app development, and specialized AI/ML problem solving.', 'details': ['Scaling an extended introduction to DBMS concepts, data connectivity for static and user responsive webpages unleashing the expertise over data structures and iOT.']},
        }
    },
    'ismart-series': {
